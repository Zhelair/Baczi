...
export const UI: Record<string, Record<Language, string>> = {
  ...
  studio:          { bg: 'Студио',      ru: 'Студия',    en: 'Studio'      },
  studioClients:        { bg: 'Клиенти',        ru: 'Клиенты',        en: 'Clients'           },
  studioSelectClient:   { bg: 'Избери клиент',  ru: 'Выберите клиент',en: 'Select a client'   },
  studioNoClients:      { bg: 'Няма клиенти. Добави лица в секция Лица.', ru: 'Нет клиентов. Добавьте персоны в разделе Персоны.', en: 'No clients. Add persons in the Persons section.' },
  studioNewChat:        { bg: '+ Нов чат',      ru: '+ Новый чат',    en: '+ New chat'        },
  studioNewChatName:    { bg: 'Име на чата',    ru: 'Название чата',  en: 'Chat name'         },
  studioDeleteChat:     { bg: 'Изтрий чат',     ru: 'Удалить чат',    en: 'Delete chat'       },
  studioBuilder:        { bg: 'Консултация',    ru: 'Консультация',   en: 'Consultation'      },
  studioBuilderTitle:   { bg: 'Генератор на консултации', ru: 'Генератор консультаций', en: 'Consultation Builder' },
  studioTopic:          { bg: 'Тема',           ru: 'Тема',           en: 'Topic'             },
  studioTopicWeekly:    { bg: 'Седмична прогноза', ru: 'Недельный прогноз', en: 'Weekly Forecast' },
  studioTopicBazi:      { bg: 'Лична BaZi консултация', ru: 'Личная Ба-Цзы консультация', en: 'Personal BaZi' },
  studioTopicFengshui:  { bg: 'Фън Шуй доклад', ru: 'Доклад Фэн Шуй', en: 'Feng Shui Report' },
  studioTopicQimen:     { bg: 'Ци Мен прогноза', ru: 'Прогноз Ци Мэнь', en: 'Qi Men Forecast' },
  studioTopicCustom:    { bg: 'Персонализирана', ru: 'Персональная',  en: 'Custom'            },
  studioGenerate:       { bg: '✨ Генерирай',    ru: '✨ Генерировать',en: '✨ Generate'        },
  studioGenerating:     { bg: 'Генерирам...',   ru: 'Генерирую...',  en: 'Generating...'     },
  studioDrafts:         { bg: 'Чернови',        ru: 'Черновики',     en: 'Drafts'            },
  studioNoDrafts:       { bg: 'Няма запазени чернови', ru: 'Нет сохранённых черновиков', en: 'No saved drafts' },
  studioSaveDraft:      { bg: 'Запази чернова', ru: 'Сохранить черновик', en: 'Save draft'    },
  studioSaved:          { bg: 'Запазено!',      ru: 'Сохранено!',   en: 'Saved!'             },
  studioCopy:           { bg: 'Копирай',        ru: 'Копировать',   en: 'Copy'               },
  studioCopied:         { bg: 'Копирано!',      ru: 'Скопировано!', en: 'Copied!'            },
  studioExportJson:     { bg: 'Експорт JSON',   ru: 'Экспорт JSON', en: 'Export JSON'        },
  studioImportJson:     { bg: 'Импорт JSON',    ru: 'Импорт JSON',  en: 'Import JSON'        },
  studioReasoning:      { bg: '? Разсъждение',  ru: '? Рассуждение',en: '? Reasoning'        },
  studioReasoningHide:  { bg: 'Скрий',          ru: 'Скрыть',       en: 'Hide'               },
  studioCustomPrompt:   { bg: 'Персонализиран въпрос / инструкция:', ru: 'Персональный запрос / инструкция:', en: 'Custom question / instruction:' },
  studioDeleteDraft:    { bg: 'Изтрий',         ru: 'Удалить',      en: 'Delete'             },
  studioLoadDraft:      { bg: 'Зареди',         ru: 'Загрузить',    en: 'Load'               },
